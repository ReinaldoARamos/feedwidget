...
exports.routes.post("/feedback", async (req, res) => {
    ...
    const nodeMailer = new nodemailer_mail_adapter_1.NodeMailerAdapter();
    const submitFeedBackUseCase = new submit_feedback_use_case_1.SubmitFeedBackUseCase(prismaFeedbacksRepository, nodeMailer);
